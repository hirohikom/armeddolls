...
public class F3DLiteVulcanController_RS : Photon.MonoBehaviour
{
    // Singleton instance
    public static F3DLiteVulcanController_RS instance;
    ...
    void LiteVulcan()
    {
        ...
        if (online)
            photonView.RPC("ShootLiteVulcan_RS", PhotonTargets.All, offset);
        else
            ShootLiteVulcan_RS(offset);
    }

    [PunRPC]
    public void ShootLiteVulcan_RS(Quaternion offset)
    {
