...
public class F3DVulcanProjectile : MonoBehaviour
{
    ...
    public float applyForce = 2.0f;
    public float applyDamage = 2.0f;
    ...
    void Update()
    {
        ...
        if (isHit)
        {
            ...
            if (!isFXSpawned)
            {
                ...
                VulcanImpact(hitPoint.point + hitPoint.normal * 0.2f);
